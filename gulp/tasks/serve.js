...
gulp.task('serve', ['build'], function() {
  ...
  gulp.watch(paths.mortarSrc + '{styles,modules,icons,contentPackages,util}/**/*.scss', ['styles']);
  gulp.watch(paths.mortarSrc + '{scripts,modules,contentPackages,util}/**/*.{js,jsx}', ['scripts']);
