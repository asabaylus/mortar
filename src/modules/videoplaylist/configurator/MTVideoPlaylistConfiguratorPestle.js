...
import VideoPlaylistConfiguratorComponent from './MTVideoPlaylistConfigurator';

class VideoPlaylistConfigurator extends Module {
  ...
  init() {
    ...
    this.instance = ReactDOM.render(<VideoPlaylistConfiguratorComponent initialProps={props} />, this.el);
    Pestle.PubSub.subscribe('Configurator.ForceUpdate', () => { this.forceUpdate(); });
  }
}

Pestle.ModuleManager.register('VideoPlaylistConfigurator', VideoPlaylistConfigurator);
