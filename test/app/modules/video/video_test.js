...
import Video from '../../../../app/modules/video/scripts/VideoPestle.js';
import VideoComponent from '../../../../app/modules/video/scripts/video.jsx';
...
describe('Video Component', () => {
  ...
  describe('React Component: LazyLoad Enabled', () => {
    ...
    it('should contain the expected mock inside LazyLoad', () => {
      expect(wrapper.childAt(1).html()).to.equal('<div class="mt2_video__player-wrapper"><div id="'+reactModel.instance+'" class="mt2_video__player" data-guid="'+reactModel.guid+'"></div></div>');
    });
  });
  ...
  describe('React Component: LazyLoad Disabled', () => {
    ...
    it('should include a div for the video player to instantiate against', () => {
      expect(wrapper.html()).to.include('<div id="'+reactModel.instance+'" class="mt2_video__player" data-guid="'+reactModel.guid+'"></div>');
    });
  });
});
